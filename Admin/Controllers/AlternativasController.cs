...
namespace Admin.Controllers
{
    public class AlternativasController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            Alternativas alternativas = db.Alternativas.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Valor,Imagem")] Alternativas alternativas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Valor,Imagem")] Alternativas alternativas)
        {
            if (ModelState.IsValid)
            {
